...
import { printError, printUnknownCommand } from "./cli-format.mjs";
...
export async function run(args) {
  try {
    ...
    printError("Unexpected failure", {
      nextAction: "Check the command inputs and run node bin/specwise.mjs --help."
    });
    return 1;
  }
}
